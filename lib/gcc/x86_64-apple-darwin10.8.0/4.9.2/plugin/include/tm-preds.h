/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/gcc/gcc-4.9.2/gcc/config/i386/i386.md'.  */
...
extern int general_reg_operand (rtx, enum machine_mode);
...
extern int ext_sse_reg_operand (rtx, enum machine_mode);
extern int mask_reg_operand (rtx, enum machine_mode);
extern int q_regs_operand (rtx, enum machine_mode);
extern int ext_register_operand (rtx, enum machine_mode);
extern int nonimmediate_x64nomem_operand (rtx, enum machine_mode);
extern int general_x64nomem_operand (rtx, enum machine_mode);
...
extern int x86_64_sext_operand (rtx, enum machine_mode);
extern int sext_operand (rtx, enum machine_mode);
extern int x86_64_zext_operand (rtx, enum machine_mode);
...
extern int call_rex64_ms_sysv_operation (rtx, enum machine_mode);
...
extern int const2367_operand (rtx, enum machine_mode);
extern int const1248_operand (rtx, enum machine_mode);
extern int const359_operand (rtx, enum machine_mode);
extern int const_4_or_8_to_11_operand (rtx, enum machine_mode);
...
extern int const_0_to_4_operand (rtx, enum machine_mode);
extern int const_0_to_5_operand (rtx, enum machine_mode);
...
extern int const_8_to_9_operand (rtx, enum machine_mode);
extern int const_8_to_11_operand (rtx, enum machine_mode);
extern int const_8_to_15_operand (rtx, enum machine_mode);
extern int const_10_to_11_operand (rtx, enum machine_mode);
extern int const_12_to_13_operand (rtx, enum machine_mode);
extern int const_12_to_15_operand (rtx, enum machine_mode);
extern int const_14_to_15_operand (rtx, enum machine_mode);
extern int const_16_to_19_operand (rtx, enum machine_mode);
extern int const_16_to_31_operand (rtx, enum machine_mode);
extern int const_20_to_23_operand (rtx, enum machine_mode);
extern int const_24_to_27_operand (rtx, enum machine_mode);
extern int const_28_to_31_operand (rtx, enum machine_mode);
...
extern int address_no_seg_operand (rtx, enum machine_mode);
...
extern int general_vector_operand (rtx, enum machine_mode);
extern int register_or_constm1_operand (rtx, enum machine_mode);
